      ...
      ? servings.serving.map(servings => {
          return {
            serving: {
              ...
              serving_description: checkIfExists(
              ...
              measurement_description: checkIfExists(
                servings.measurement_description,
                t,
              ),
              metric_serving_amount: checkIfExists(
                servings.metric_serving_amount,
                t,
              ),
              metric_serving_unit: checkIfExists(
      ...
      ? [
          {
            serving: {
              ...
              serving_description: checkIfExists(
                data.food.servings.serving.serving_description,
                t,
              ),
              carbohydrate: checkIfExists(
                data.food.servings.serving.carbohydrate,
                t,
              ),
              cholesterol: checkIfExists(
              ...
              measurement_description: checkIfExists(
                data.food.servings.serving.measurement_description,
                t,
              ),
              metric_serving_amount: checkIfExists(
                data.food.servings.serving.metric_serving_amount,
                t,
              ),
              metric_serving_unit: checkIfExists(
                data.food.servings.serving.metric_serving_unit,
                t,
              ),
              number_of_units: checkIfExists(
